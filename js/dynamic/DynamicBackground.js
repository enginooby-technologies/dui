...
export class DynamicBackground {
    ...
    initOuterBg() {
        ...
        if (this.hasCustomBg) {
            ...
            this.currentOuterBg = (_b = DynamicUI.currentStyle) === null || _b === void 0 ? void 0 : _b.outerBg;
    ...
    initInnerBg() {
        ...
        (_a = this.esInnerBgContainers) === null || _a === void 0 ? void 0 : _a.forEach((element) => {
            var _a;
            element.classList.add((_a = DynamicUI.currentStyle) === null || _a === void 0 ? void 0 : _a.innerBg);
        });
        this.currentInnerBg = (_b = DynamicUI.currentStyle) === null || _b === void 0 ? void 0 : _b.innerBg;
    }
    initDropdowns() {
    ...
    applyCurrentStyleOuterBg() {
        var _a, _b;
        if (this.currentOuterBg == ((_a = DynamicUI.currentStyle) === null || _a === void 0 ? void 0 : _a.outerBg))
            return;
    ...
    applyCurrentStyleInnerBg() {
        var _a, _b;
        if (this.currentInnerBg == ((_a = DynamicUI.currentStyle) === null || _a === void 0 ? void 0 : _a.innerBg))
            return;
        this.lastInnerBg = this.currentInnerBg;
        this.currentInnerBg = (_b = DynamicUI.currentStyle) === null || _b === void 0 ? void 0 : _b.innerBg;
        this.onChangeInnerBg();
    ...
    onFirstTimeSelectOuterBg() {
        ...
        DynamicUI.$body.removeClass((_b = DynamicUI.currentStyle) === null || _b === void 0 ? void 0 : _b.outerBg);
    }
    onChangeOuterBg() {
    ...
    onFirstTimeSelectInnerBg() {
        ...
        this.esInnerBgContainers.forEach((element) => {
            var _a;
            element.classList.remove((_a = DynamicUI.currentStyle) === null || _a === void 0 ? void 0 : _a.innerBg);
